...
determinant <https://en.wikipedia.org/wiki/Determinant>`__.
...
Read more about `matrix
transpose <https://en.wikipedia.org/wiki/Transpose>`__.
...
Read more about `invertible
matrix <https://en.wikipedia.org/wiki/Invertible_matrix>`__
