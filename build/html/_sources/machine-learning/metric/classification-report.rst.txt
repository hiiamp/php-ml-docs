...
Class for calculate main classifier metrics: precision, recall, F1 score
and support.
...
-  precision (``getPrecision()``) - fraction of retrieved instances that
   are relevant
-  recall (``getRecall()``) - fraction of relevant instances that are
   retrieved
