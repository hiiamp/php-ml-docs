...
-  $epsilon (float) - epsilon in loss function of epsilon-SVR (default
   0.1)
...
To predict sample target value use ``predict`` method. You can provide
one sample or array of samples:
